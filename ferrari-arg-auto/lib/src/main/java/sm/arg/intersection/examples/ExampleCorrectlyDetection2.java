...
public class ExampleCorrectlyDetection2 {
    ...
    public static void main(final String[] args) throws ParserException, IOException {
        ...
        ExampleCorrectlyDetection2.log.info(fourWC.toString());
        ...
        ExampleCorrectlyDetection2.log.info(t.toString());
        ...
        ExampleCorrectlyDetection2.log.info("{} --> {}", pf, ar.query(t, pf, InferenceMode.CREDULOUS));
